...
if __name__=="__main__":
    ...
    # print("Loading weights from: ", opt.pretrained_weights)
    generator.load_state_dict(torch.load(opt.pretrained_weights, map_location=torch.device('cpu')))
    ...
    for i in range(test_loader.size):
        ...
        # print("Saving mask to: ", os.path.join(opt.output_mask, name))
