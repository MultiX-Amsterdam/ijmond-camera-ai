...
class Generator(nn.Module):
    ...
    def forward(self, x, y=None, training=True):
        if training:
            ...
            _, self.prob_pred, output = self.sal_encoder(x, z_noise)
            return self.prob_pred, output
...
class Saliency_feat_encoder(nn.Module):
    ...
    def forward(self, x, z):
        ...
        return self.upsample8(sal_init), self.upsample4(sal_ref), output
