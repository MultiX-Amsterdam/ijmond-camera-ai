...
image_root = os.path.join(opt.dataset_path, "img/") # 'SMOKE5K/SMOKE5K/SMOKE5K/train/img/'
gt_root = os.path.join(opt.dataset_path, "gt/") #'SMOKE5K/SMOKE5K/SMOKE5K/train/gt/'
trans_map_root = os.path.join(opt.dataset_path, "trans/") #'SMOKE5K/SMOKE5K/SMOKE5K/train/trans/'
