...
if __name__ == "__main__":
    convert_all_images_to_npy("test/img", "test/img_npy")
    convert_all_images_to_npy("test/gt", "test/gt_npy")
    convert_all_images_to_npy("train/img", "train/img_npy")
    convert_all_images_to_npy("train/gt", "train/gt_npy")
    create_smoke5k_metadata("test/img_npy", "test/gt_npy", "smoke5k_metadata_test.json")
    create_smoke5k_metadata("train/img_npy", "train/gt_npy", "smoke5k_metadata_train.json")