...
Notice that in this experiment setting for RQ1, we have an assumption that using unlabeled data can increase performance. If time permits, we should do an ablation study on the effect of removing the unlabeled data from the models to see the effect.