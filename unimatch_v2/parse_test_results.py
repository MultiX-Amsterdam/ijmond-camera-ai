...
TABLE_ROWS = [
    ...
    ("m-mix-20-box",   "Mix-20-soft-box",    "100\\% (soft with box)", "20\\%"),
    ("m-mix-20",       "Mix-20-hard-mask",   "100\\% (hard with mask)", "20\\%"),
    ("m-mix-20-awl",   "Mix-20-hard-box",    "100\\% (hard with box)", "20\\%"),
    None,
    ("m-expert-40",    "Expert-40",          "0\\% (n/a)",   "40\\%"),
    ("m-mix-40-box",   "Mix-40-soft-box",    "100\\% (soft with box)", "40\\%"),
    ("m-mix-40",       "Mix-40-hard-mask",   "100\\% (hard with mask)", "40\\%"),
    ("m-mix-40-awl",   "Mix-40-hard-box",    "100\\% (hard with box)", "40\\%"),
    None,
    ("m-expert-60",    "Expert-60",          "0\\% (n/a)",   "60\\%"),
    ("m-mix-60-box",   "Mix-60-soft-box",    "100\\% (soft with box)", "60\\%"),
    ("m-mix-60",       "Mix-60-hard-mask",   "100\\% (hard with mask)", "60\\%"),
    ("m-mix-60-awl",   "Mix-60-hard-box",    "100\\% (hard with box)", "60\\%"),
    None,
    ("m-expert-80",    "Expert-80",          "0\\% (n/a)",   "80\\%"),
    ("m-mix-80-box",   "Mix-80-soft-box",    "100\\% (soft with box)", "80\\%"),
    ("m-mix-80",       "Mix-80-hard-mask",   "100\\% (hard with mask)", "80\\%"),
    ("m-mix-80-awl",   "Mix-80-hard-box",    "100\\% (hard with box)", "80\\%"),
    None,
